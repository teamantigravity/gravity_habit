  ...
  static const all = [
    ConstellationDef(
      ...
      nodes: [
        ...
        ConstellationNode(
            name: 'First Note', criteria: 'Write a completion note'),
        ConstellationNode(
            name: 'Perfect Day', criteria: 'Complete all habits in a day'),
      ],
    ),
    ConstellationDef(
      id: 'builder',
      ...
      nodes: [
        ...
        ConstellationNode(
            name: 'Stone Habit', criteria: 'Create a Stone+ habit'),
    ...
    ConstellationDef(
      ...
      nodes: [
        ConstellationNode(
            name: 'First Recovery', criteria: 'Return after missing a day'),
        ConstellationNode(
            name: 'Skip With Grace', criteria: 'Skip with a reason'),
        ConstellationNode(
            name: 'Freeze Used', criteria: 'Have a freeze save a streak'),
        ConstellationNode(name: 'Comeback', criteria: 'Return after 3+ days'),
        ConstellationNode(
            name: 'Recovery Quest', criteria: 'Complete a recovery quest'),
        ConstellationNode(name: 'Surpass', criteria: 'Surpass a broken streak'),
        ConstellationNode(
            name: '10 Reflections', criteria: 'Write 10 reflection notes'),
      ],
    ),
    ConstellationDef(
      id: 'composer',
      ...
      nodes: [
        ...
        ConstellationNode(
            name: 'All Types', criteria: 'Use binary, count, and duration'),
        ...
        ConstellationNode(
            name: '10 Emojis', criteria: 'Use 10 different emojis'),
        ConstellationNode(
            name: 'Custom Palette', criteria: 'Unlock custom palette editor'),
      ],
    ),
    ConstellationDef(
      id: 'navigator',
      ...
      nodes: [
        ConstellationNode(
            name: '30-Day Streak', criteria: '30-day streak on any habit'),
        ConstellationNode(
            name: '100 Completions', criteria: '100 total completions'),
        ConstellationNode(
            name: '500 Completions', criteria: '500 total completions'),
        ConstellationNode(name: '100-Day Streak', criteria: '100-day streak'),
        ConstellationNode(
            name: '1000 Completions', criteria: '1000 total completions'),
        ConstellationNode(
            name: 'Year Installed', criteria: 'App installed for 1 year'),
        ConstellationNode(
            name: '2 Years Installed', criteria: 'App installed for 2 years'),
      ],
    ),
    ConstellationDef(
      id: 'alchemist',
      ...
      nodes: [
        ...
        ConstellationNode(
            name: '4-Habit Stack', criteria: 'Have 4 linked habits'),
        ConstellationNode(
            name: '25 Quests', criteria: 'Complete 25 daily quests'),
        ConstellationNode(
            name: '50 Quests', criteria: 'Complete 50 daily quests'),
        ConstellationNode(
            name: '100 Quests', criteria: 'Complete 100 daily quests'),
      ],
    ),
    ConstellationDef(
      id: 'oracle',
      ...
      nodes: [
        ...
        ConstellationNode(
            name: 'Year in Review', criteria: 'Complete a year-in-review'),
      ],
    ),
    ConstellationDef(
      id: 'gravity_itself',
      ...
      nodes: [
        ...
        ConstellationNode(
            name: '100K Mass', criteria: 'Accumulate 100,000 mass'),
        ConstellationNode(
            name: '500K Mass', criteria: 'Accumulate 500,000 mass'),
        ConstellationNode(name: 'Tier 100', criteria: 'Reach Tier 100'),
        ConstellationNode(
            name: '1M Mass', criteria: 'Accumulate 1,000,000 mass'),
      ],
    ),
  ];
}
